        ...
        <div className='flex-1 bg-white rounded-xl mx-5'>
            <div className='flex items-center justify-between px-4'>
                ...
                <div className='flex items-center gap-2'>
                        <p className='text-sm text-gray-500'>1-5- 1000 </p>
                        ...
                        mailType.map((item, index) => {
                            return (
                                <button
                                    ...
                                    className={`${mailTypeSelected == index ? 'border-b-4 border-b-blue-600 text-blue-600' : 'border-b-4 border-b-transparent'}flex items-center gap-5 p-1 w-52 hover:bg-gray-100`}
